...
v7 = StringVar()
L10 = Label(tk, text="Comm 1").grid(row = 4, column = 20, columnspan = 2)
E7 = Entry(tk, textvariable = v7)
E7.grid(row = 4, column = 22, columnspan = 20, padx = 10)
v7.set("Privgu")
       
v8 = StringVar()
L11 = Label(tk, text="1's Twitter").grid(row = 5, column = 20, columnspan = 2)
E8 = Entry(tk, textvariable = v8)
E8.grid(row = 5, column = 22, columnspan = 20, padx = 10)
v8.set("@Privgu")

v9 = StringVar()
L12 = Label(tk, text="Comm 2").grid(row = 6, column = 20, columnspan = 2)
E9 = Entry(tk, textvariable = v9)
E9.grid(row = 6, column = 22, columnspan = 20, padx = 10)
v9.set("Final Smasher")

v10 = StringVar()
L13 = Label(tk, text="2's Twitter").grid(row = 7, column = 20, columnspan = 2)
E10 = Entry(tk, textvariable = v10)
E10.grid(row = 7, column = 22, columnspan = 20, padx = 10)
